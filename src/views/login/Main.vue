  ...
  <div>
    ...
    <div class="container overflow-hidden sm:px-10 ">
      <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
          ...
          <div class="my-auto">
            <img
              ...
              src="https://avatars.mds.yandex.net/i?id=d55f8fd9ed9c13cb1aa51d994625cff5b273ff8f-9683096-images-thumbs&n=13"
            />
            <div
        ...
        <!-- BEGIN: Login Form -->
        <div
          class="h-screen overflow-hidden  xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0 bg-red"
        >
          <div
          ...
          >
            ...
            <form @submit.prevent="login">
              ...
              <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                <button
                  class="btn btn-primary py-3 px-4 w-full xl:w-70 xl:mr-3 align-top"
                  type="submit"
                  :disabled="loading"
                >
                  <span

  ...
  <div class="top-bar">
    ...
    <div class="intro-x dropdown w-8 h-8">
      <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button"
        aria-expanded="false">
        <img alt="Icewall Tailwind HTML Admin Template" src="https://avatars.mds.yandex.net/i?id=63e0f20ba6f13207e41e5809721f79e7571a89bb-9211188-images-thumbs&n=13`).default" />
      </div>
      <div class="dropdown-menu w-56">
        <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
          ...
          <div class="p-2 border-t border-theme-27 dark:border-dark-3">
            <button @click="loginpushpage" style="width: 100%;"
              class="flex items-center  p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
    ...
    return {
      data: {
        ...
        flag: [
          {
            name: "RU",
            img: "https://avatars.mds.yandex.net/i?id=3e0317e813716c3ee9c4f69d9259d7e3f81755b4-12529607-images-thumbs&n=13",
          },
          {
            name: "EN",
